...
export function Header() {
  ...
  const handleSignOut = async () => {
    ...
    // Small delay to let the user see the goodbye animation
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed inset-0 z-[100] flex items-center justify-center bg-background/80 backdrop-blur-md transition-all duration-700 ease-in-out pointer-events-none",
          isSigningOut ? "opacity-100 scale-100 pointer-events-auto" : "opacity-0 scale-110"
        )}
      >
        <div className="flex flex-col items-center gap-6 animate-out fade-out zoom-out duration-700">
            ...
            <div className="text-center space-y-2">
                <h2 className="text-3xl font-black tracking-tighter uppercase">Goodbye for now!</h2>
                <p className="text-muted-foreground font-medium uppercase tracking-widest text-[10px]">Your session is ending securely...</p>
            </div>
        </div>
      </div>
    </>
